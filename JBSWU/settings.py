"""
Django settings for JBSWU project.
...
SECRET_KEY = 'django-insecure-)ak*q1l*)t1ju)8)!#0oak(f7yk^f@4!)e0zyhk^#3_or_)h5o'
...
WSGI_APPLICATION = 'JBSWU.wsgi.application'
